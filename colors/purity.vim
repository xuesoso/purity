...
" Name:       purity
" Author:     YSX
" Repository: https://github.com/xuesoso/purity/
" License:    The MIT License (MIT)
" Copyright:  YSX (xuesoso@gmail.com)
" 
" Clean and beautiful colorscheme for vim based on Kyoz/purifier. Modified
" colorschemes for work on dark / transparent background(neovim)
" ==============================================================================
...
let s:colors = purity#get_colors()
...
if !exists('g:purity_bold')
  let g:purity_bold = 1
endif

if !exists('g:purity_italic')
  let g:purity_italic = 1
endif

if !exists('g:purity_underline')
  let g:purity_underline = 1
endif

if !exists('g:purity_undercurl') && g:purity_underline != 0
  let g:purity_undercurl = 1
endif

if !exists('g:purity_inverse')
  let g:purity_inverse = 1
endif

let s:styles = {
      \ 'bold':      g:purity_bold == 1 ? 'bold' : 0,
      \ 'italic':    g:purity_italic == 1 ? 'italic' : 0,
      \ 'underline': g:purity_underline == 1 ? 'underline' : 0,
      \ 'undercurl': g:purity_undercurl == 1 ? 'undercurl' : 0,
      \ 'inverse':   g:purity_inverse == 1 ? 'inverse' : 0,
      \ }
...
call s:hi('LineNr',       { 'fg': s:dark_yellow })
